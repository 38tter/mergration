...
Entity and Relations can be written in Mermaid.js syntax on markdown files, and migration files will be generated by running `bin/rails generate mergtaion:install`.
